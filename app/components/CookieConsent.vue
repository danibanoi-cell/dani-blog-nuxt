  ...
  <Transition name="slide-up">
    <div v-if="showBanner" class="cookie-banner" role="region" aria-label="Cookie consent">
      <div class="cookie-content">
        ...
        <p class="cookie-text">
          Questo sito utilizza cookie tecnici necessari per il funzionamento. Continuando la navigazione accetti l'uso dei cookie. Maggiori informazioni nella nostra <a href="#privacy" class="cookie-link">privacy policy</a>.
        </p>
